...
python3 -W ignore /workspace/code/hads_temp_parse.py $CUSTOM_DATE
echo "---madis_temp_parse.py---"
python3 -W ignore /workspace/code/madis_temp_parse.py $CUSTOM_DATE
echo "---himeso_temp_parse.py---"
python3 -W ignore /workspace/code/himeso_temp_parse.py $CUSTOM_DATE
echo "---air_temp_aggregate_wrapper.py---"
python3 -W ignore /workspace/code/air_temp_aggregate_wrapper.py $CUSTOM_DATE
